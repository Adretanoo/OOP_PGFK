package com.lebovich.diary.domain.validators;

import java.util.Scanner;

/**
 * Клас для валідації введення користувача в меню.
 */
