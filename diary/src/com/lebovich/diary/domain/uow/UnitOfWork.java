package com.lebovich.diary.domain.uow;

import com.lebovich.diary.persistence.repository.UserRepository;

/**
 * Клас, що реалізує патерн "Одиниця роботи" (Unit of Work).
 * Відповідає за управління транзакціями та збереженням змін у json.
 */
