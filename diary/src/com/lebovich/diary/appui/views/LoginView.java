...
import com.lebovich.diary.domain.uow.UnitOfWork;
import com.lebovich.diary.persistence.entitys.User;
...
public class LoginView {
     ...
     * Перевіряє правильність введених даних і надає доступ до програми для користувачів.
     */
    public void display() {
        ...
        while (true) {
            ...
            if (user != null && BCrypt.checkpw(password, user.getPasswordHash())) {
                ...
                loggedInEmail = email;  // Зберігаємо email користувача
                new UserView(loggedInEmail).display();  // Передаємо email в UserView
                return;
            } else {
