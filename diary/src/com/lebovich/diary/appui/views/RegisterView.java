...
public class RegisterView {
    ...
    public void display() {
        ...
        saveUser(newUser);
        System.out.println("Реєстрація успішна! Перехід у головне меню...");

        // Після успішної реєстрації відкриваємо головне меню
        new UserView(email).display();  // Передаємо email в UserView
    }
